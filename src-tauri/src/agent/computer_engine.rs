...
#[cfg(target_os = "linux")]
use crate::agent::computer_atspi;
#[cfg(target_os = "linux")]
use crate::agent::computer_wayland;
...
fn focus_window_by_title(title: &str) -> Result<()> {
    if crate::agent::shell::command_exists("wmctrl") {
    ...
    } else if crate::agent::shell::command_exists("xdotool") {
